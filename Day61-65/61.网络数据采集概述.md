...
![http-request](../res/20210824003915.png)
...
![http-response](../res/20210824234158.png)
...
1. Chrome Developer Tools：谷歌浏览器内置的开发者工具。该工具最常用的几个功能模块是：
   ...
   ![chrome-developer-tools](../res/20210824004034.png)

2. Postman：功能强大的网页调试与 RESTful 请求工具。Postman可以帮助我们模拟请求，非常方便的定制我们的请求以及查看服务器的响应。

   ![postman](../res/20210824004048.png)
...
![crawler-workflow](../res/20210824004107.png)
